...
var $author$project$Main$GotLesson = function (a) {
	return {$: 'GotLesson', a: a};
};
...
var $author$project$Main$getLesson = function (i) {
	return $elm$http$Http$get(
		{
			expect: $elm$http$Http$expectString($author$project$Main$GotLesson),
			url: A2(
				$elm$url$Url$Builder$absolute,
				_List_fromArray(
					[
						'lessons',
						'lesson' + ($elm$core$String$fromInt(i) + '.md')
					]),
				_List_Nil)
		});
};
...
var $author$project$Main$Lesson = function (a) {
	return {$: 'Lesson', a: a};
};
var $author$project$Main$Lessons = {$: 'Lessons'};
	...
	_List_fromArray(
		[
			...
			A2(
				...
				$elm$url$Url$Parser$s('lesson'),
				$elm$url$Url$Parser$int)),
			A2(
			$elm$url$Url$Parser$map,
			$author$project$Main$Question,
			$elm$url$Url$Parser$s('question'))
		]));
var $author$project$Main$route = function (url) {
	var _v0 = A2($elm$url$Url$Parser$parse, $author$project$Main$routes, url);
	if (_v0.$ === 'Just') {
		var x = _v0.a;
		return x;
	} else {
...
var $author$project$Main$init = F3(
	function (flags, url, navkey) {
		var nroute = $author$project$Main$route(url);
		var ncmd = function () {
			if (nroute.$ === 'Lesson') {
				var i = nroute.a;
				return $author$project$Main$getLesson(i);
			} else {
				return $elm$core$Platform$Cmd$none;
			}
		}();
		return _Utils_Tuple2(
			A3($author$project$Main$Model, nroute, navkey, $elm$core$Maybe$Nothing),
			ncmd);
	});
...
var $author$project$Main$update = F2(
	function (msg, _v0) {
		...
		switch (msg.$) {
			case 'NoOp':
				return _Utils_Tuple2(
					A3($author$project$Main$Model, p, k, md),
					$elm$core$Platform$Cmd$none);
			case 'UrlChanged':
				var p1 = msg.a;
				var newpage = $author$project$Main$route(p1);
				var nCmd = function () {
					if (newpage.$ === 'Lesson') {
						var s = newpage.a;
						return $author$project$Main$getLesson(s);
					} else {
						return $elm$core$Platform$Cmd$none;
					}
				}();
				return _Utils_Tuple2(
					A3($author$project$Main$Model, newpage, k, md),
					$author$project$Main$getLesson(1));
			case 'LinkClicked':
			...
			default:
				...
				if (les.$ === 'Ok') {
					...
					var e = les.a;
					return _Utils_Tuple2(
						A3($author$project$Main$Model, p, k, $elm$core$Maybe$Nothing),
						$elm$core$Platform$Cmd$none);
				}
		}
	});
...
var $author$project$Main$header = A2(
	...
	_List_fromArray(
		[
			$elm$html$Html$Attributes$class('header header--light')
		]),
	_List_fromArray(
		[
			A2(
			...
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('header__items')
				]),
			_List_fromArray(
				[
					A2(
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('header__brand')
						]),
					_List_fromArray(
						[
							A2(
							...
							_List_fromArray(
								[
									...
									$elm$html$Html$Attributes$class('header--light header__links__item')
								]),
							_List_fromArray(
								[
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('header__links')
						]),
					_List_fromArray(
						[
							A2(
							...
							_List_fromArray(
								[
									$elm$html$Html$Attributes$class('header__links__item header--light'),
...
var $author$project$Main$card = F5(
	function (link_, photo_, title_, subtitle_, buttont_) {
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('card__image'),
							$elm$html$Html$Attributes$src(photo_)
						]),
					_List_Nil),
					A2(
					$elm$html$Html$div,
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$Attributes$class('card__text')
								]),
							_List_fromArray(
								[
									$elm$html$Html$text(subtitle_)
								]))
						])),
					A2(
					$elm$html$Html$a,
					_List_fromArray(
						[
							$elm$html$Html$Attributes$href(link_),
							$elm$html$Html$Attributes$class('card__button')
						]),
					_List_fromArray(
						[
							$elm$html$Html$text(buttont_)
						]))
				]));
	});
var $author$project$Main$lesson = F4(
	function (num, photo_url, name, desc_) {
		return A5(
			...
			name,
			desc_,
			'Lesson' + $elm$core$String$fromInt(num));
	});
var $elm$html$Html$h1 = _VirtualDom_node('h1');
var $author$project$Main$section = F2(
	function (title_, content_) {
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('section__row')
						]),
					content_)
				]));
	});
var $author$project$Main$lessons = A2(
	$author$project$Main$section,
	'Lessons',
	_List_fromArray(
		[
			A4($author$project$Main$lesson, 1, 'https://s3-us-west-2.amazonaws.com/courses-images/wp-content/uploads/sites/1861/2017/06/23161835/apple-slicing-function.png', 'What is a Function', 'What is a Function? Input and Ouput')
		]));
var $author$project$Main$resources = A2(
	$author$project$Main$section,
	'Resources',
	_List_fromArray(
		[
			A5($author$project$Main$card, 'http://replit.com', 'https://replit.com/public/images/blog/multi.png', 'Practice with ReplIt', 'Repl', 'Start Practicing'),
			A5($author$project$Main$card, 'question', 'https://media0.giphy.com/media/sxERTFNh52gJzVHVU4/200.gif', 'Need Help', ' Contact Me', ' Contact Me')
		]));
var $author$project$Main$schedule = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
			$elm$html$Html$Attributes$class('schedule schedule--light')
		]),
	_List_fromArray(
		[
			A2(
			...
			_List_fromArray(
				[
					$elm$html$Html$text('Meeting Schedule')
				])),
			A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('schedule__days')
				]),
			_List_fromArray(
				[
					A2(
					...
					_List_fromArray(
						[
							$elm$html$Html$text(' Sunday 3-4pm EST')
						])),
					A2(
					$elm$html$Html$h3,
					_List_Nil,
					_List_fromArray(
						[
							$elm$html$Html$text(' Tuesday 4:30-5:30pm EST')
						]))
				])),
			A2(
			$elm$html$Html$a,
			_List_fromArray(
				[
					$elm$html$Html$Attributes$href('https://meet.google.com/azx-ptoc-nka'),
					$elm$html$Html$Attributes$class('schedule__button')
				]),
			_List_fromArray(
				[
...
var $author$project$Main$show = function (markdown) {
	return A2(
		$elm$core$Result$andThen,
		function (ast) {
...
var $author$project$Main$splash = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
			$elm$html$Html$Attributes$class('splash splash--light')
		]),
	_List_fromArray(
		[
			A2(
			...
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('splash__image'),
					$elm$html$Html$Attributes$src('/programming.svg')
				]),
			_List_Nil),
			A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('splash__title')
				]),
			_List_fromArray(
				[
					A2(
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$href('/lessons'),
							$elm$html$Html$Attributes$class('splash__button')
						]),
					_List_fromArray(
						[
							$elm$html$Html$text('Start Learning')
						]))
				]))
		]));
var $author$project$Main$view = function (_v0) {
	...
	switch (p.$) {
			...
			return {
				body: _List_fromArray(
					[
						...
						_List_fromArray(
							[$author$project$Main$header, $author$project$Main$splash, $author$project$Main$schedule, $author$project$Main$lessons, $author$project$Main$resources]))
					]),
				title: 't3kroots'
			};
		case 'Lessons':
			return {
				body: _List_fromArray(
					[
						...
						_List_fromArray(
							[$author$project$Main$header, $author$project$Main$lessons]))
					]),
							...
							[
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$elm$html$Html$text('You can send me an email at help@t3kroots.com')
											]))
									]))
							]))
					]),
		...
		default:
			...
			var idk = function () {
				var _v2 = $author$project$Main$show(mdt);
				if (_v2.$ === 'Ok') {
					var sdc = _v2.a;
					return A2(
						$elm$html$Html$div,
			...
			return {
				body: _List_fromArray(
					[
						...
						_List_fromArray(
							[$author$project$Main$header, idk]))
					]),
				title: 't3kroots - Lesson ' + $elm$core$String$fromInt(i)
			};
	}
};
...
_Platform_export({'Main':{'init':$author$project$Main$main(
	$elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.1"},"types":{"message":"Main.Msg","aliases":{"Url.Url":{"args":[],"type":"{ protocol : Url.Protocol, host : String.String, port_ : Maybe.Maybe Basics.Int, path : String.String, query : Maybe.Maybe String.String, fragment : Maybe.Maybe String.String }"}},"unions":{"Main.Msg":{"args":[],"tags":{"NoOp":[],"UrlChanged":["Url.Url"],"LinkClicked":["Browser.UrlRequest"],"GotLesson":["Result.Result Http.Error String.String"]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String.String"],"Timeout":[],"NetworkError":[],"BadStatus":["Basics.Int"],"BadBody":["String.String"]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"Url.Protocol":{"args":[],"tags":{"Http":[],"Https":[]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}},"String.String":{"args":[],"tags":{"String":[]}},"Browser.UrlRequest":{"args":[],"tags":{"Internal":["Url.Url"],"External":["String.String"]}}}}})}});
...
//# sourceMappingURL=/t3kroots.e31bb0bc.js.map